...
Tags: json,webservice,api,twig,live,data,connect,template,import,content,cache,opendata,parser,html,application
...
[youtube https://www.youtube.com/watch?v=IiMfE_CUPBo]
...
== Upgrade Notice ==
Version 1.2.19: * Plugin is ok with Wordpress 4.9.1, New option: Debug-Mode shows how the Plugin gets JSON and converts it, more flexible Authorization possible, if PHP-MultibyteString is not installed: plugin can be used now